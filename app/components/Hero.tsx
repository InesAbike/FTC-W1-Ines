        ...
        <section className="relative z-10 py-10">
            <div className="lg:py-16 py-12 flex flex-col items-center justify-between gap-8">
                <div className="text-center sm:max-w-4xl max-w-full mx-auto flex flex-col gap-6 items-center justify-between">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-extralight mb-6 bg-gradient-to-r from-[#dedde2] to-[#80739e] bg-clip-text text-transparent">
                        Modern analytics
                        <br />
                        for the modern world
                    </h1>
                    <p className="text-lg md:text-xl text-light-gray font-extralight mb-8 max-w-2xl mx-auto">

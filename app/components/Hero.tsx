...
const Hero = () => {
    return (
        <section className="relative z-10 py-10">
            <div className="lg:py-16 md:py-8 py-4 flex flex-col items-center justify-between gap-8">
                <div className="text-center sm:max-w-4xl max-w-full mx-auto flex flex-col gap-6 items-center justify-between">
                    <div className="lg:mb-12 mb-6 max-w-96 mx-auto">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-base lg:mb-6 mb-0 bg-gradient-to-r from-[#dedde2] to-[#80739e] bg-clip-text text-transparent">
                        Modern analytics
                        <br />
                        for the modern world
                    </h1>
                    <p className="text-lg md:text-xl text-light-gray font-base lg:mb-8 mb-0 max-w-2xl mx-auto">
